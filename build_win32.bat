...
SET c_filenames=%SRC_DIR%\app.c %SRC_DIR%\camera.c %SRC_DIR%\render_pass.c %SRC_DIR%\debug_render_pass.c %SRC_DIR%\imgui_render_pass.c %SRC_DIR%\components.c %SRC_DIR%\physics_system.c %SRC_DIR%\gravity_system.c
