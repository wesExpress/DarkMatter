...
dm_input_state* dm_current_input = NULL;
dm_input_state* dm_prev_input = NULL;

void dm_input_init()
{
	dm_current_input = dm_alloc(sizeof(dm_input_state), DM_MEM_INPUT);
	dm_prev_input = dm_alloc(sizeof(dm_input_state), DM_MEM_INPUT);
}

void dm_input_shutdown()
{
	dm_free(dm_current_input, sizeof(dm_input_state), DM_MEM_INPUT);
	dm_free(dm_prev_input, sizeof(dm_input_state), DM_MEM_INPUT);
}
