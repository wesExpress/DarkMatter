...
// getters for mouse
DM_API uint32_t dm_input_get_mouse_x();
DM_API uint32_t dm_input_get_mouse_y();
DM_API void dm_input_get_mouse_pos(uint32_t* x, uint32_t* y);
DM_API void dm_input_get_mouse_delta(int* x, int* y);
DM_API int dm_input_get_mouse_delta_x();
DM_API int dm_input_get_mouse_delta_y();
