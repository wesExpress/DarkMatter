...
IF not defined opengl (
	...
	ECHO Compiling shader: new_shader_pixel.hlsl
	fxc %fxc_flags% /E p_main /T ps_5_0 %SRC_DIR%/engine/shaders/hlsl/new_shader_pixel.hlsl /Fo %SRC_DIR%/engine/shaders/hlsl/new_shader_pixel.fxc
)