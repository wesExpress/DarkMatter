...
Features
    ...
    Public facing structures: Hash map
    Internal structures: 'slot' array (see Gunslinger) and a byte pool
    Initial implementation of full 3D physics collision and resolution system
        ...
        Mostly working! Some weird bugs still present in certain edge cases
